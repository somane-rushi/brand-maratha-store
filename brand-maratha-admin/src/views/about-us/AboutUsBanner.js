...
import {
  _aboutusbanner_create,
  _aboutusbanner_delete,
  _aboutusbanner_get,
  _aboutusbanner_update,
  _aboutusbannermarathi_get,
  _aboutusbannermarathi_create,
  _aboutusbannermarathi_update,
  _aboutusbannermarathi_delete,
  _url_aboutusBanner_img

} from '../../config/api.endpoints';
import { CAlert, CButton, CCard, CCardBody, CCardHeader, CCol, CForm, CFormCheck, CFormFeedback, CFormInput, CFormLabel, CFormSelect, CInputGroup, CInputGroupText, CRow, CSpinner } from '@coreui/react';
...
const AboutUsBanner = () => {
  ...
  useEffect(() => {
    const newEndpoint = {
      getBanner: language === "english" ? _aboutusbanner_get : _aboutusbannermarathi_get,
      postBanner: language === "english" ? _aboutusbanner_create : _aboutusbannermarathi_create,
      putBanner: language === "english" ? _aboutusbanner_update : _aboutusbannermarathi_update,
      deleteBanner: language === "english" ? _aboutusbanner_delete : _aboutusbannermarathi_delete,
    };
                        ...
                        >
                          ...
                          <CCol md={6}>
                            ...
                            <div>
                              ...
                              <ImagePreview
                                visible={showPreviewModal}
                                imageFile={preview?.startsWith("blob:") ? preview : _url_aboutusBanner_img + preview}
                                onClose={() => setShowPreviewModal(false)}
                              />
                            </div>
