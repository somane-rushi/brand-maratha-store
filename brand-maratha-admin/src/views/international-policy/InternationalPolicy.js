...
import {
    _internationalpolicies_get,
    _internationalpolicies_create,
    _internationalpolicies_update,
    _internationalpoliciesmarathi_get,
    _internationalpoliciesmarathi_create,
    _internationalpoliciesmarathi_update
...
const InternationalPolicy = () => {
    ...
    useEffect(() => {
        setEndpoint({
            getBanner: language === "english" ? _internationalpolicies_get : _internationalpoliciesmarathi_get,
            postBanner: language === "english" ? _internationalpolicies_create : _internationalpoliciesmarathi_create,
            putBanner: language === "english" ? _internationalpolicies_update : _internationalpoliciesmarathi_update,
        });
    }, [language]);
