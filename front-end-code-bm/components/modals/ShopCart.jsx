...
export default function ShopCart() {
    ...
    return (
        <div
            className="modal fullRight fade modal-shopping-cart bs-modal-shopingCart"
            id="shoppingCart"
        >
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="header">
                        <div className="title fw-5">{t("Shopping_Cart", language)}</div>
                        <span
                                ...
                                <div className="tf-mini-cart-sroll">
                                    ...
                                    <div className="tf-minicart-recommendations">
                                        ...
                                        <Swiper
                                            ...
                                            className="swiper tf-cart-slide shoppingCart-products-slider"
                                        >
                                            {products1
                                                .slice(0, 2)
                                                .map((elm, i) => (
                            ...
                            <div className="tf-mini-cart-bottom">
                                <div className="tf-mini-cart-tool">
                                    <div
                                        ...
                                        onClick={() =>
                                            addNoteRef.current.classList.add(
                                                "open"
                                            )
                                        }
                                    >
                                    ...
                                    <div
                                        ...
                                        onClick={() =>
                                            addGiftRef.current.classList.add(
                                                "open"
                                            )
                                        }
                                    >
                                    ...
                                    <div
                                        ...
                                        onClick={() =>
                                            addShipingRef.current.classList.add(
                                                "open"
                                            )
                                        }
                                    >
                                ...
                                <div className="tf-mini-cart-bottom-wrap">
                                    ...
                                    <div className="tf-mini-cart-view-checkout">
                                        <Link
                                            href={`/view-cart`}
                                            className="tf-btn btn-outline radius-3 link w-100 justify-content-center fw-4"
                                        >
                                            {"View_cart"}
                                        </Link>
                                        <Link
                                            href={`/checkout`}
                                            className="tf-btn btn-fill animate-hover-btn radius-3 w-100 justify-content-center fw-4"
                                        >
                                            <span>{"Check_out"}</span>
                                        </Link>
                                    </div>
