                            ...
                            <div className="widget-card-store bg_grey-10 radius-10 o-hidden type-2 align-items-center tf-grid-layout md-col-2">
                                <div className="store-item-info">
                                    ...
                                    <div className="description">
                                        <div>
                                            Award-winning designs, engineered
                                            and tested to keep going for
                                        </div>
                                        <div>generations.</div>
                                    </div>
                                    <Link
                        ...
                        >
                            <div className="widget-card-store bg_grey-10 radius-10 o-hidden type-2 align-items-center tf-grid-layout md-col-2">
                                <div className="store-item-info">
                                    ...
                                    <div className="description">
                                        <div>
                                            Immerse yourself in a creative space
                                            where every step
                                        </div>
                                        <div>
                                            is an adventure of innovation.
                                        </div>
                                    </div>
                                    <Link
                                        href={`/shop-default`}
