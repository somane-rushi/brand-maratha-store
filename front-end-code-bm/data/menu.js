...
export const productsPages = [
  {
    heading: "Ethnic/Traditional Footwear",
    links: [
      { href: "#", text: "Kolhapuri Sandals" },
      { href: "#", text: "Mojaris" },
      { href: "#", text: "Padukas" },
      { href: "#", text: "Traditional Juttis" },
    ],
  },
  {
    heading: "Fashion/Party Wear",
    links: [
      { href: "#", text: "High Heels" },
      { href: "#", text: "Pumps" },
      { href: "#", text: "Wedges" },
      { href: "#", text: "Boots" },
    ],
  },
  {
    ...
    links: [
      { href: "#", text: "Sandals" },
      { href: "#", text: "Flip-Flops" },
      { href: "#", text: "Loafers" },
      { href: "#", text: "Slip-Ons" },
    ],
  },
  {
    heading: "Formal Footwear",
    links: [
      { href: "#", text: "Office Shoes" },
      { href: "#", text: "Oxfords" },
      { href: "#", text: "Derby Shoes" },
      { href: "#", text: "Formal Leather Shoes" },
    ],
  },
];
...
export const navItems = [
  ...
  //     { href: "/contact-us", label: "Contact 1" },
  ...
  {
    id: "dropdown-menu-one",
    label: "Ethnic/Traditional Footwear",
    links: [
      { href: "#", label: "Kolhapuri Sandals" },
      { href: "#", label: "Mojaris" },
      { href: "#", label: "Kolhapu" },
      { href: "#", label: "Traditional Juttis" },
    ],
  },
  {
    id: "dropdown-menu-two",
    label: "Fashion/Party Wear",
    links: [
      { href: "#", label: "High Heels" },
      { href: "#", label: "Pumps" },
      { href: "#", label: "Wedges" },
      { href: "#", label: "Boots" },
    ],
  ...
  },
  {
    ...
    links: [
      { href: "#", label: "Office Shoes" },
      { href: "#", label: "Oxfords" },
      { href: "#", label: "Derby Shoes" },
      { href: "#", label: "BootFormal Leather Shoes" },
    ],
  },
];
