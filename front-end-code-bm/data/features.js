...
export const iconBoxData = [
  {
    ...
    imgSrc:"/images/brand-maratha/home/easy-returns.png",
    title: "Easy Returns",
    // description: "Within 30 days for an exchange",
  },
  {
    // iconClass: "icon-shipping",
    imgSrc:"/images/brand-maratha/home/honest-pricing.png",
    title: "Honest Pricing",
    // description: "Free shipping over order $120",
  },
  {
    // iconClass: "icon-suport",
    imgSrc:"/images/brand-maratha/home/handcreafted.png",
    title: "Handcrafted",
    // description: "Outstanding premium support",
  },
  {
    // iconClass: "icon-payment fs-22",
    imgSrc:"/images/brand-maratha/home/secure-transation.png",
...
export const abouticonBoxes = [
  {
    imgSrc: "/images/brand-maratha/icon/user.svg",
    alt: "icon",
    width: 40,
    height: 40,
  ...
  {
    imgSrc: "/images/brand-maratha/icon/diamond.svg",
     alt: "icon",
    width: 40,
    height: 40,
    title: "100% Authentic Maharashtrian Products",
    // description:
    //   "Simplicity refined. Our activewear embodies the essence of minimalistic design, delivering effortless style that speaks volumes.",
  },
  {
    imgSrc: "/images/brand-maratha/icon/primium.svg",
     alt: "icon",
    width: 40,
    height: 40,
...
export const abouticonBoxes1 = [
  {
    iconClass: "/images/collections/cls-sock2.jpg",
    title: "Trusted by Thousands of Customers",
    // description:
    //   "lorem ipsum",
  },
